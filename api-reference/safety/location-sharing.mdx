...
description: "Location Sharing documentation for API Reference > Safety Services. Learn about implementation, configuration, and best practices."
api: "POST https://api.shelther.app/v1/safety/location-sharing"
---
