---
title: "Websockets"
description: "Websockets documentation for API Reference > Real-time. Learn about implementation, configuration, and best practices."
api: "POST https://api.shelther.app/v1/realtime/websockets"
---
