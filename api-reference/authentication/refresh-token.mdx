---
title: "Refresh Token"
description: "Refresh Token documentation for API Reference > Authentication. Learn about implementation, configuration, and best practices."
api: "POST https://api.shelther.app/v1/authentication/refresh-token"
---
