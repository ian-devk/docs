---
title: "Login"
description: "Login documentation for API Reference > Authentication. Learn about implementation, configuration, and best practices."
api: "POST https://api.shelther.app/v1/authentication/login"
---
