---
title: "Devices"
description: "Devices documentation for API Reference > User Management. Learn about implementation, configuration, and best practices."
api: "POST https://api.shelther.app/v1/users/devices"
---
